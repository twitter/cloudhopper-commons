...
public class SxmpServletProcessor {
    private static final Logger logger = Logger.getLogger(SxmpServletProcessor.class);
    ...
    protected void doProcess(SxmpProcessor processor, InputStream in, PrintWriter out, String uri, String method, String contentType) throws IOException, HttpStatusCodeException {
        ...
        if (response == null) {
            logger.fatal("The response from SxmpSession.process() was null -- should be impossible");
