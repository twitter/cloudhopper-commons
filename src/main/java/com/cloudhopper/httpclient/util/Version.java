...
public final class Version {
    private static final String TIMESTAMP="20110918-1822";
    private static final String VERSION="1.4.1";
    private static final String NAME="ch-httpclient-util";
    private static final String VENDOR="cloudhopper";
    private static final String LONG_VERSION="1.4.1 (Build @ 20110918-1822)";
    /** Returns the library vendor such as "cloudhopper" */
    static public String getVendor() { return VENDOR; }
    /** Returns the library build timestamp such as "20110918-1822" */
    static public String getTimestamp() { return TIMESTAMP; }
    /** Returns the library name such as "ch-httpclient-util" */
    static public String getName() { return NAME; }
    /** Returns the library version such as "1.4.1" */
    static public String getVersion() { return VERSION; }
    /** Returns a longer library version that includes the timestamp such as "1.4.1 (Build @ 20110918-1822)" */
