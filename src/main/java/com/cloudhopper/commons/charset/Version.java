...
public final class Version {
    private static final String TIMESTAMP="20111025-2146";
    ...
    private static final String LONG_VERSION="2.3.0 (Build @ 20111025-2146)";
    /** Returns the library vendor such as "cloudhopper" */
    static public String getVendor() { return VENDOR; }
    /** Returns the library build timestamp such as "20111025-2146" */
    ...
    /** Returns a longer library version that includes the timestamp such as "2.3.0 (Build @ 20111025-2146)" */
