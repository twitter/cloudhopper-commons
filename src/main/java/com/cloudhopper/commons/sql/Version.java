...
public final class Version {
    private static final String TIMESTAMP="20111010-2312";
    ...
    private static final String LONG_VERSION="1.1.0-SNAPSHOT (Build @ 20111010-2312)";
    /** Returns the library vendor such as "cloudhopper" */
    static public String getVendor() { return VENDOR; }
    /** Returns the library build timestamp such as "20111010-2312" */
    ...
    /** Returns the library version such as "1.1.0-SNAPSHOT" */
    static public String getVersion() { return VERSION; }
    /** Returns a longer library version that includes the timestamp such as "1.1.0-SNAPSHOT (Build @ 20111010-2312)" */
