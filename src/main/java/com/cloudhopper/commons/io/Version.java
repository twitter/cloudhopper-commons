...
public final class Version {
    private static final String TIMESTAMP="20110901-2305";
    ...
    private static final String LONG_VERSION="2.2.2 (Build @ 20110901-2305)";
    /** Returns the library vendor such as "cloudhopper" */
    static public String getVendor() { return VENDOR; }
    /** Returns the library build timestamp such as "20110901-2305" */
    ...
    /** Returns a longer library version that includes the timestamp such as "2.2.2 (Build @ 20110901-2305)" */
