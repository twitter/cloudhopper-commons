...
public final class Version {
    private static final String TIMESTAMP="20110726-2007";
    ...
    private static final String LONG_VERSION="5.1.0 (Build @ 20110726-2007)";
    /** Returns the library vendor such as "cloudhopper" */
    static public String getVendor() { return VENDOR; }
    /** Returns the library build timestamp such as "20110726-2007" */
    ...
    /** Returns a longer library version that includes the timestamp such as "5.1.0 (Build @ 20110726-2007)" */
