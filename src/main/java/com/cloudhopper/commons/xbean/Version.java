...
public final class Version {
    ...
    /** Returns the library version such as "2.0.1" */
    static public String getVersion() { return VERSION; }
    /** Returns a longer library version that includes the timestamp such as "2.0.1 (Build @ 20120217-1228)" */
