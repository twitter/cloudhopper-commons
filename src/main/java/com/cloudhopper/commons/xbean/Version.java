...
public final class Version {
    private static final String TIMESTAMP="20120215-2203";
    ...
    private static final String LONG_VERSION="2.0.0-SNAPSHOT (Build @ 20120215-2203)";
    /** Returns the library vendor such as "cloudhopper" */
    static public String getVendor() { return VENDOR; }
    /** Returns the library build timestamp such as "20120215-2203" */
    ...
    /** Returns a longer library version that includes the timestamp such as "2.0.0-SNAPSHOT (Build @ 20120215-2203)" */
